...
export async function generateAiExplanation(jobId) {
  return parseResponse(
    await fetch(`${API_BASE_URL}/analysis/jobs/${jobId}/ai-explanation`, {
      method: "POST",
      credentials: "include"
    })
  );
...
export async function getAiExplanation(jobId) {
  return parseResponse(
    await fetch(`${API_BASE_URL}/analysis/jobs/${jobId}/ai-explanation`, {
      credentials: "include"
    })
